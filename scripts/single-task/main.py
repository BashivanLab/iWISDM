...
if __name__ == '__main__':
    ...
    print(vars(args))
    trainer = Trainer(train_set, val_set, device, static=args.static, out_dir='/home/lucasg/mlti-dl/scripts/outputs/single-task/', args=vars(args))
    ...
    plot_dict(all_loss, fname='/home/lucasg/mlti-dl/scripts/outputs/single-task/' + args.model_name + '_loss_graph_' + now + '.png')
    plot_dict(all_acc, fname='/home/lucasg/mlti-dl/scripts/outputs/single-task/' + args.model_name + '_acc_graph_' + now + '.png')
