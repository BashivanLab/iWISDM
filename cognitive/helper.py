...
op_dict = {"Select": {"n_downstream": 0,
                      "downstream": [],},
           "GetCategory": {"n_downstream": 1,
                      "downstream": ["Select"],
                      "sample_dist": [1]},
           "GetLoc":{"n_downstream": 1,
                      "downstream": ["Select"],
                     "sample_dist": [1]},
           "GetViewAngle": {"n_downstream": 1,
                      "downstream": ["Select"],
                      "sample_dist": [1]},
           "GetObject": {"n_downstream": 1,
                      "downstream": ["Select"],
                      "sample_dist": [1]},
           "Exist": {"n_downstream": 1,
                      "downstream": ["Select"],
                     "sample_dist": [1]},
           "Equal": {"n_downstream": 2,
                      "downstream": ["GetCategory", "GetLoc", "GetViewAngle", "GetObject",],
                        "sample_dist": [1/4, 1/4,1/4,1/4],
                     "IsSame": True, }, # same downstream op
           "NotEqual": {"n_downstream": 2,
                      "downstream": ["GetCategory", "GetLoc", "GetViewAngle", "GetObject",],
                        "sample_dist": [1/4, 1/4,1/4,1/4],
                        "IsSame": True,}, # same downstream op
           "And": {"n_downstream": 2,
