...
def get_args():
    ...
    parser.add_argument('--max_depth', type=int, default=5, help='the depth of the task graph')
    parser.add_argument('--max_op', type=int, default=10, help='the maximum number of operators in the task')
    parser.add_argument('--max_switch', type=int, default=2, help='the maximum number of switch operators in the taks graph')
    ...
    parser.add_argument('--n_tasks', type=int, default=100, help='number of tasks to generate')
